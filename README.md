...
This code is implemented in `python3` using [Keras](https://keras.io/) framework with [Tensorflow](https://www.tensorflow.org/) as backend.
...
Here are the generated digits after every every 1000 epochs. As you can see, in the begining the model gives random noise as output but as the number of epochs increases and as the model learns, it generates realistic outputs. 
